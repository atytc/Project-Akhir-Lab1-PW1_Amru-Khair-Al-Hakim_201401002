...
if($op == 'delete'){
    $id         = $_GET['id'];
    $sql1       = "delete from dbrqa where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from dbrqa where id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nis && $nama && $alamat && $kelas) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update dbrqa set nis = '$nis',nama='$nama',alamat = '$alamat',kelas='$kelas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into dbrqa(nis,nama,alamat,kelas) values ('$nis','$nama','$alamat','$kelas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<html lang="en">
    <head>
        ...
        <title>Database - RQA Ahada</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="YPI.png" class="mb-2" alt="..." />      Database RQA Ahada</a>
        ...
        <div class="jumbotron">
            <div class="container">
                <div class="col-lg-12 text-center mt-5 mb-5">
                    <h3 class="display-4" id="font-amru">Database Siswa/i RQA Ahada</h3>
                </div>
            </div>
        </div>
        ...
        <!-- untuk memasukkan data -->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php
                        header("refresh: 5; url=data_rqa.php");
                    }
                    ?>
                    <?php
                    if ($sukses) {
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="kelas" id="kelas">
                                    ...
                                    <option value="Abu Bakar Ash Shiddiq" <?php if ($kelas == "I") echo "selected" ?>>Abu Bakar Ash Shiddiq</option>
                                    <option value="Umar bin Khattab" <?php if ($kelas == "II") echo "selected" ?>>Umar bin Khattab</option>
                                    <option value="Ali bin Abi Thallib" <?php if ($kelas == "III") echo "selected" ?>>Ali bin Abi Thallib</option>
                                    <option value="Utsman bin Affan" <?php if ($kelas == "IV") echo "selected" ?>>Utsman bin 'Affan</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql2   = "select * from dbrqa order by id desc";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="row">
                                        <a href="data_rqa.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                        <a href="data_rqa.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                    </td>
                                </tr>
                            <?php
                            }
