...
if($op == 'delete'){
    $id         = $_GET['id'];
    $sql1       = "delete from dbsiswa where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from dbsiswa where id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nis && $nama && $alamat && $kelas) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update dbsiswa set nis = '$nis',nama='$nama',alamat = '$alamat',kelas='$kelas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into dbsiswa(nis,nama,alamat,kelas) values ('$nis','$nama','$alamat','$kelas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<html lang="en">
    <head>
        ...
        <title>Database - MIS Al-Hafizh</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="YPI.png" class="mb-2" alt="..." />      Database MIS Al-Hafizh</a>
        ...
        <div class="jumbotron">
            <div class="container">
                <div class="col-lg-12 text-center mt-5 mb-5">
                    <h3 class="display-4" id="font-amru">Database Siswa/i MIS Al-Hafizh</h3>
                </div>
            </div>
        </div>
        ...
        <!-- untuk memasukkan data -->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php
                        header("refresh: 5; url=data_mis.php");
                    }
                    ?>
                    <?php
                    if ($sukses) {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql2   = "select * from dbsiswa order by id desc";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="row">
                                        <a href="data_mis.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                        <a href="data_mis.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                    </td>
                                </tr>
                            <?php
                            }
